...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	let if_block1 = /*isPassword*/ ctx[1] && create_if_block_1$1(ctx);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*number*/ ctx[0]);
    			attr_dev(div, "class", "number svelte-12zfugi");
    			add_location(div, file$4, 52, 12, 1338);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "is-password svelte-12zfugi");
    			add_location(div, file$4, 55, 12, 1424);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*isBlack*/ ctx[2] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "field svelte-12zfugi");
    			add_location(div, file$4, 49, 0, 1207);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["number", "isPassword", "isBlack", "isSelected", "row", "column"];
    ...
    class Field extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*isSelected*/ ctx[7] === undefined && !("isSelected" in props)) {
    			console.warn("<Field> was created without expected prop 'isSelected'");
    		}
    ...
    const file$3 = "src/Crossword.svelte";
    ...
    // (47:8) {#if Object.keys($crossword.schema).length > 0}
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(47:8) {#if Object.keys($crossword.schema).length > 0}",
    		ctx
    	});
    ...
    // (50:20) {#each Object.keys($crossword.schema[rowKey]) as columnKey}
    function create_each_block_1(ctx) {
    	let field;
    	let current;

    	const field_spread_levels = [
    		/*$crossword*/ ctx[0].schema[/*rowKey*/ ctx[2]][/*columnKey*/ ctx[5]],
    		{ row: /*rowKey*/ ctx[2] },
    		{ column: /*columnKey*/ ctx[5] }
    	];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(field_spread_levels, [
    					get_spread_object(/*$crossword*/ ctx[0].schema[/*rowKey*/ ctx[2]][/*columnKey*/ ctx[5]]),
    					{ row: /*rowKey*/ ctx[2] },
    					{ column: /*columnKey*/ ctx[5] }
    				])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:20) {#each Object.keys($crossword.schema[rowKey]) as columnKey}",
    		ctx
    	});
    ...
    // (48:12) {#each Object.keys($crossword.schema) as rowKey}
    function create_each_block(ctx) {
    	let div;
    	let t;
    	let current;
    	let each_value_1 = Object.keys(/*$crossword*/ ctx[0].schema[/*rowKey*/ ctx[2]]);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "field-group svelte-1kyoxgh");
    			add_location(div, file$3, 48, 16, 1310);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$crossword, Object, toggleSelect*/ 3) {
    				each_value_1 = Object.keys(/*$crossword*/ ctx[0].schema[/*rowKey*/ ctx[2]]);
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(48:12) {#each Object.keys($crossword.schema) as rowKey}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if (if_block) if_block.c();
    			attr_dev(div0, "class", "crossword svelte-1kyoxgh");
    			add_location(div0, file$3, 45, 4, 1153);
    			attr_dev(div1, "class", "crossword-editor svelte-1kyoxgh");
    			add_location(div1, file$3, 44, 0, 1118);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Settings.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$1, 60, 4, 1253);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "name", "rows");
    			add_location(input0, file$1, 61, 4, 1288);
    			attr_dev(label1, "for", "columns");
    			add_location(label1, file$1, 62, 4, 1346);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "name", "columns");
    			add_location(input1, file$1, 63, 4, 1387);
    			attr_dev(button0, "class", "svelte-1ia0xan");
    			add_location(button0, file$1, 64, 4, 1451);
    			attr_dev(button1, "class", "svelte-1ia0xan");
    			add_location(button1, file$1, 65, 4, 1546);
    			attr_dev(div, "class", "settings svelte-1ia0xan");
    			add_location(div, file$1, 59, 0, 1226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (23:1) {#if $app.editMode && !$crossword.schema}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(23:1) {#if $app.editMode && !$crossword.schema}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 20, 0, 386);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
