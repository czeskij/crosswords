...
var app = (function () {
    ...
    // (87:4) {#if $selectedFields.length >= 1}
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "change", /*toggleBlack*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(87:4) {#if $selectedFields.length >= 1}",
    		ctx
    	});
    ...
    // (98:4) {#if $selectedFields.length === 1}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$3, 99, 12, 2913);
    			attr_dev(input0, "type", "number");
    			attr_dev(input0, "name", "field-number");
    			add_location(input0, file$3, 100, 12, 2966);
    			attr_dev(div0, "class", "setting svelte-1hfq426");
    			add_location(div0, file$3, 98, 8, 2879);
    			attr_dev(label1, "for", "is-password");
    			add_location(label1, file$3, 106, 12, 3201);
    			attr_dev(input1, "type", "checkbox");
    			attr_dev(input1, "name", "is-password");
    			add_location(input1, file$3, 107, 12, 3263);
    			attr_dev(div1, "class", "setting svelte-1hfq426");
    			add_location(div1, file$3, 105, 8, 3167);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(98:4) {#if $selectedFields.length === 1}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 85, 0, 2440);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function input_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			...
    			(($$invalidate(1, isBlackCheckbox), $$invalidate(5, areFieldsIndeterminate)), $$invalidate(0, $selectedFields));
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("areFieldsIndeterminate" in $$props) $$invalidate(5, areFieldsIndeterminate = $$props.areFieldsIndeterminate);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$selectedFields*/ 1) {
    			$$invalidate(5, areFieldsIndeterminate = !areAllFieldsBlack($selectedFields) && !areAllFieldsWhite($selectedFields));
    		}

    		if ($$self.$$.dirty & /*areFieldsIndeterminate*/ 32) {
    			if (areFieldsIndeterminate) {
